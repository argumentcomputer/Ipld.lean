...
--
--  #eval encode Base32 zero
--  #eval decode Base32 "bab4wk4zanvqw42jaee"
--  --def foobar := ByteArray.mk #[102,111,111,98,97,114]
--  def foobar : List UInt8 := [102,111,111,98,97,114]
--
--  def iso (β : Type) [Multibase β] (x: List UInt8) : Option (List UInt8) :=
--    decode β (encode β x)
--  
--  #eval decode Base64URLPad "UeWVzIG1hbmkgIQ=="
--
